...
function addRecipe($ID, $title, $instructions, $ImageID, $description, $tags) {
  global $database_host, $database_user, $database_pass, $database_name;
  $sql = "INSERT INTO Recipes (userID, title, instructions, imageID, description, tags) VALUES (:userID, :title, :instructions, :imageID, :description, :tags)";
  $pdo = new pdo("mysql:dbname=$database_name;host=$database_host", $database_user, $database_pass);
  $stmt = $pdo->prepare($sql);
